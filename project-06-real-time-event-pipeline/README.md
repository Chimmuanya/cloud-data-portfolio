# project-06-real-time-event-pipeline
...
Add a draw.io diagram in `project-06-real-time-event-pipeline/diagrams/` and exported PNG in `project-06-real-time-event-pipeline/diagrams/exported/`.
