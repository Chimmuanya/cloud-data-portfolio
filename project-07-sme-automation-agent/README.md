# project-07-sme-automation-agent
...
Add a draw.io diagram in `project-07-sme-automation-agent/diagrams/` and exported PNG in `project-07-sme-automation-agent/diagrams/exported/`.
