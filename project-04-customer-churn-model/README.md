# project-04-customer-churn-model
...
Add a draw.io diagram in `project-04-customer-churn-model/diagrams/` and exported PNG in `project-04-customer-churn-model/diagrams/exported/`.
