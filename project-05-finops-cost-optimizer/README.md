# project-05-finops-cost-optimizer
...
Add a draw.io diagram in `project-05-finops-cost-optimizer/diagrams/` and exported PNG in `project-05-finops-cost-optimizer/diagrams/exported/`.
